...
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($a, $d, false, array('json' => false, 'xml' => false, 'html' => true), NULL));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($a, $d, false, array('json' => false, 'xml' => false, 'html' => true), NULL));
$f->addLoader($e);

...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\annoncecontroller' => 'AppBundle\\Controller\\AnnonceController',
            'appbundle\\controller\\defaultcontroller' => 'AppBundle\\Controller\\DefaultController',
            'appbundle\\form\\annoncetype' => 'AppBundle\\Form\\AnnonceType',
            'appbundle\\form\\userphototype' => 'AppBundle\\Form\\UserPhotoType',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\AccountController' => 'getAccountControllerService.php',
            'AppBundle\\Controller\\AnnonceController' => 'getAnnonceControllerService.php',
            'AppBundle\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'AppBundle\\Form\\AnnonceType' => 'getAnnonceTypeService.php',
            'AppBundle\\Form\\UserPhotoType' => 'getUserPhotoTypeService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\AnnonceType' => true,
            'AppBundle\\Form\\UserPhotoType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NLJoW4Ip7N', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O77LBp94yN', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PxGmoa5wlV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zzkB3YHrl-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pqLqvSpBI2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', array(0 => function () {
            return ${($_ = isset($this->services['fos_rest.allowed_methods_listener']) ? $this->services['fos_rest.allowed_methods_listener'] : $this->getFosRest_AllowedMethodsListenerService()) && false ?: '_'};
        }, 1 => 'onKernelResponse'), 0);
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['fos_rest.zone_matcher_listener']) ? $this->services['fos_rest.zone_matcher_listener'] : $this->getFosRest_ZoneMatcherListenerService()) && false ?: '_'};
    ...
    {
        return $this->services['fos_rest.allowed_methods_loader'] = new \FOS\RestBundle\Response\AllowedMethodsLoader\AllowedMethodsRouterLoader(${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, ($this->targetDirs[0].'/fos_rest'), true);
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('/api', NULL, array(0 => 'GET', 1 => 'POST', 2 => 'DELETE', 3 => 'PUT'), NULL, array()), array('methods' => array(0 => 'GET', 1 => 'POST', 2 => 'DELETE', 3 => 'PUT'), 'priorities' => array(0 => 'json'), 'fallback_format' => 'json', 'attributes' => array(), 'stop' => false, 'prefer_extension' => '2.0'));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'photo_directory': $value = ($this->targetDirs[3].'/web/img'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'projet_annuel@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'projet_annuel@gmail.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'projet_annuel@gmail.com' => 'projet_annuel@gmail.com',
            ),

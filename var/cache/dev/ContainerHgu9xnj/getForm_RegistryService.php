...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AnnonceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AnnonceType']) ? $this->services['AppBundle\Form\AnnonceType'] : $this->services['AppBundle\Form\AnnonceType'] = new \AppBundle\Form\AnnonceType()) && false ?: '_'};
}, 'AppBundle\\Form\\UserPhotoType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UserPhotoType']) ? $this->services['AppBundle\Form\UserPhotoType'] : $this->services['AppBundle\Form\UserPhotoType'] = new \AppBundle\Form\UserPhotoType()) && false ?: '_'};
